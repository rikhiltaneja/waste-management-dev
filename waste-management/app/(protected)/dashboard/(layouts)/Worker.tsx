...
const mockWorkerComplaints: Complaint[] = [
  ...
  {
    id: 4,
    description: "Garbage bins overflowing near the bus stop. Urgent cleaning required.",
  ...
  {
    id: 7,
    description: "Construction debris dumped illegally. Needs immediate removal.",
    ...
    <div className="bg-background">
      <div className="p-4 sm:p-0 space-y-4 sm:space-y-6">
        ...
        <DashboardHeroSection
          title={profile.name}
          showHeading={true}
          leftSideProp={{ label: "Completed Tasks:", value: completedComplaints.length }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card className="p-4 bg-blue-50 border-blue-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-800">{inProgressComplaints.length}</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 bg-green-50 border-green-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-800">{completedComplaints.length}</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 bg-orange-50 border-orange-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-orange-600 font-medium">Total Assigned</p>
                  <p className="text-2xl font-bold text-orange-800">{allAssignedComplaints.length}</p>
                </div>
              </div>
            </Card>
          </div>
        ...
        <section>
          ...
          <Tabs defaultValue="in-progress" className="w-full">
            ...
            <TabsContent value="in-progress" isActive={activeTab === "in-progress"} className="mt-6">
              {inProgressComplaints.length === 0 ? (
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-sm mt-1">All your assigned complaints are completed.</p>
                </div>
              ) : (
            ...
            <TabsContent value="completed" isActive={activeTab === "completed"} className="mt-6">
              {completedComplaints.length === 0 ? (
                <div className="text-center py-12 text-gray-500">
                  <div className="text-4xl mb-4">📋</div>
                  <p className="text-lg font-medium text-gray-700">No completed tasks yet</p>
            ...
            <TabsContent value="all" isActive={activeTab === "all"} className="mt-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
...
function WorkerComplaintCard({ complaint, onAction, onViewDetails }: WorkerComplaintCardProps) {
      ...
      <div className="p-4 space-y-3">
        <div className="flex justify-between items-start">
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <h3 className="font-semibold text-lg text-gray-900">Task #{complaint.id}</h3>
        ...
        <div className="flex items-center gap-2 p-2 bg-blue-50 rounded-md">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-gray-900">{complaint.citizen.name}</p>
        ...
        {complaint.status === 'RESOLVED' && complaint.rating > 0 && (
          <div className="p-2 bg-yellow-50 rounded-md space-y-1">
            ...
            {complaint.reviewText && (
              <p className="text-xs text-gray-600 italic">{complaint.reviewText}</p>
            )}
          </div>
        )}
        ...
        {complaint.status === 'RESOLVED' && (
          <div className="flex items-center gap-2 p-2 bg-green-50 rounded-md">
            ...
            <span className="text-xs text-green-700 font-medium">Task Completed Successfully</span>
          </div>
        )}
